...
The goal of traveltimeSF is to ...

## Installation

You can install the released version of traveltimeSF from [CRAN](https://CRAN.R-project.org) with:

``` r
install.packages("traveltimeSF")
```
